...
<header>
    ...
    <nav id="menu">
        ...
        <a>
            <form id="searchbox" action="" method="post">
                THÉO_SEARCH_BAR<br><input class="research" type="text" size="40" name="search"
    ...
    <nav id="user">
        ...
        <ul>
            ...
            <li><a href="../pages/subscriptions.php?user_id=<?php echo $_SESSION['connected_id'] ?>">mes abonnements</a>
            </li>
